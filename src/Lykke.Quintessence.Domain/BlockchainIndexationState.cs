...
using Lykke.Quintessence.Core.IntervalTree;

namespace Lykke.Quintessence.Domain
{
    public class BlockchainIndexationState : IEnumerable
    {
        ...
        public static BlockchainIndexationState Restore(
            [NotNull] IEnumerable<BlockIntervalIndexationState> indexationStates)
        {
        ...
        public IEnumerator<BlockIntervalIndexationState> GetEnumerator()
        {
            return _stateTree
                .Select(x => new BlockIntervalIndexationState
                (
        ...
        public bool TryToMarkBlockAsIndexed(
