...
{
    public class DefaultTransactionReceiptRepository : ITransactionReceiptRepository
    {
        ...
        public DefaultTransactionReceiptRepository(
            ...
            ILogFactory logFactory)
        {
            ...
            return new DefaultTransactionReceiptRepository
            (
